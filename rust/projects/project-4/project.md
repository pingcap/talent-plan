...
- [Background: blocking and multithreading](#user-conetent-background-blocking-and-multithreading)
- [Part 1: Multithreading](#user-conetent-part-1-multithreading)
- [Part 2: Creating a shared `KvsEngine`](#user-conetent-part-2-creating-a-shared-kvsengine)
- [Part 3: Adding multithreading to `KvServer`](#user-conetent-part-3-adding-multithreading-to-kvserver)
- [Part 4: Creating a real thread pool](#user-conetent-part-4-creating-a-real-thread-pool)
  - [So how do you build a thread pool?](#user-conetent-so-how-do-you-build-a-thread-pool)
- [Part 5: Abstracted thread pools](#user-conetent-part-5-abstracted-thread-pools)
- [Part 6: Evaluating your thread pool](#user-conetent-part-6-evaluating-your-thread-pool)
  - [Ok, now to the first two benchmarks](#user-conetent-ok-now-to-the-first-two-benchmarks)
- [Part 7: Evaluating other thread pools and engines](#user-conetent-part-7-evaluating-other-thread-pools-and-engines)
  - [Extension 1: Comparing functions](#user-conetent-extension-1-comparing-functions)
  - [Background: The limits of locks](#user-conetent-background-the-limits-of-locks)
- [Part 8: Lock-free readers](#user-conetent-part-8-lock-free-readers)
  - [Explaining our example data structure](#user-conetent-explaining-our-example-data-structure)
  - [Strategies for breaking up locks](#user-conetent-strategies-for-breaking-up-locks)
    - [Understand and maintain sequential consistency](#user-conetent-understand-and-maintain-sequential-consistency)
    - [Identify immutable values](#user-conetent-identify-immutable-values)
    - [Duplicate values instead of sharing](#user-conetent-duplicate-values-instead-of-sharing)
    - [Break up data structures by role](#user-conetent-break-up-data-structures-by-role)
    - [Use specialized concurrent data structures](#user-conetent-use-specialized-concurrent-data-structures)
    - [Postpone cleanup until later](#user-conetent-postpone-cleanup-until-later)
    - [Share flags and counters with atomics](#user-conetent-share-flags-and-counters-with-atomics)
  - [Implement lock-free readers](#user-conetent-implement-lock-free-readers)
